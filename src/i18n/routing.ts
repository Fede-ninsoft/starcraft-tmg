...
export type LocalizedPage = 'home' | 'builder' | 'lists' | 'public-lists' | 'games' | 'profile' | 'support' | 'faqs' | 'organised-play' | 'tournaments' | 'public-list' | 'guest-builder' | 'terms' | 'register' | 'check-email' | 'verify-email' | 'reset-password';

const paths: Record<SupportedLocale, Record<LocalizedPage, string>> = {
  es: { tournaments: 'torneos', home: 'inicio', builder: 'nueva-lista', lists: 'mis-listas', 'public-lists': 'listas-publicas', games: 'partidas', profile: 'perfil', support: 'soporte', faqs: 'faqs', 'organised-play': 'reglas-de-torneo', 'public-list': 'listas-publicas', 'guest-builder': 'crear-lista', terms: 'terminos-y-condiciones', register: 'registro', 'check-email': 'revisa-tu-correo', 'verify-email': 'verificar-correo', 'reset-password': 'restablecer-contrasena' },
  en: { tournaments: 'tournaments', home: 'home', builder: 'new-list', lists: 'my-lists', 'public-lists': 'public-lists', games: 'games', profile: 'profile', support: 'support', faqs: 'faqs', 'organised-play': 'organised-play', 'public-list': 'public-lists', 'guest-builder': 'create-list', terms: 'terms-and-conditions', register: 'register', 'check-email': 'check-your-email', 'verify-email': 'verify-email', 'reset-password': 'reset-password' },
};
