...
export type LocalizedPage = 'home' | 'builder' | 'lists' | 'public-lists' | 'games' | 'profile' | 'support' | 'faqs' | 'organised-play' | 'public-list' | 'guest-builder' | 'terms' | 'register' | 'check-email' | 'verify-email' | 'reset-password';
